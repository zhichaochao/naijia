          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <input type="text" name="filter_order_id" value="<?php echo $filter_order_id; ?>" placeholder="" id="input-order-id" class="form-control" />
              </div>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=sale/orders&token=<?php echo $token; ?>';
