              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <td class="text-center"><a href="" id="thumb-mimage-<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $banner_image['m_thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>

                      <input type="hidden" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][m_image]" value="<?php echo $banner_image['m_image']; ?>" id="input-mimage<?php echo $image_row; ?>" /></td>
...
function addImage(language_id) {
  ...
  html += '  <td class="text-center"><a href="" id="thumb-mimage' + image_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="banner_image[' + language_id + '][' + image_row + '][m_image]" value="" id="input-mimage' + image_row + '" /></td>';
