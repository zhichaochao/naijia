      ...
      <div class="text right_text clearfix">
        ...
        <div class="form_div clearfix" id="register-form-div">
          ...
          <div class="r_text clearfix">
            <p> 1, After sign up, you can continually received the reward points as 
                same as the amount you pay in each of your order.
                (For example if you buy 30K, you will get 30K reward points)<br />
              2, You can be our S-VIP as long as your total order amount over 
                800K, you can enjoy all products with 10% off. 
            </p>
          </div>
