...
<!--banner-->
                ...
                <div class="swiper-container" id="swiper1">
                    <div class="swiper-wrapper" style="cursor:-webkit-grab;">
                        ...
                        <div class="swiper-slide ban_img">
                            <a href="<?=$banner['link']?>"><img class="changeimage lazyLoad" data-image='<?=$banner["image"]?>' data-mimage='<?=$banner["image"]?>'  /></a>
                        </div>
                          <?php }} ?>
                    </div>
        ...
        <div class="index_con">
          ...
          <!-- 优惠券 -->
                ...
                <li class="clearfix">
                  <div class="bg_fff clearfix">
                    ...
                    <div class="text clearfix">
                     ...
                     <?php if(!empty($hot['special'])){?>
                    <div class="discount"><span class="sp_1">-<?php echo $hot['percent']; ?>%</span><span class="sp_2">off</span></div>
                    <?php } ?>
                  </div>
                </li>
                <?php } } ?>
            ...
            <a class="pro_mores" href="<?php echo $hotsproduct ?>">View More&nbsp;&nbsp;></a>
          </div>
            <!--产品评价-->
            <div class="text2 clearfix">
              ...
              <div class="in_review clearfix">
                ...
                <div class="text clearfix">
                  ...
                  <div class="start">
                    <i class="bg_hui"><i class="bg_red" style="width: 80%"></i></i>
                     <!--  <ol>
                        <?php for ($i = 1; $i <= 5; $i++) { ?>
                  ...
                  <a href="<?php echo $homes?>" onclick="event.stopPropagation()" class="a_btn">View More</a>
                </div>
              </div>
                <?php } ?>
                <?php } ?>
