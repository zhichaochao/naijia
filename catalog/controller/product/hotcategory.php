...
// 		$category_info = $this->model_catalog_hotproduct->getHotproduct($category_id);
...
// 			$data['sort_sort_order'] = $this->url->link('product/hotproduct', 'token='  . '&sort=p.price' . $url, true);
// 			$data['sort_sort_order_d'] = $this->url->link('product/hotproduct', 'token='  . '&sort=p.price&order=DESC' . $url, true);
// 			$data['sort_sort_add'] = $this->url->link('product/hotproduct', 'token='  . '&sort=p.date_added' . $url, true);
// 			$data['sort_sort_rating'] = $this->url->link('product/hotproduct', 'token='  . '&sort=rating' . $url, true);
// 			//产品对比按钮
// 			//$data['text_compare'] = sprintf($this->language->get('text_compare'), (isset($this->session->data['compare']) ? count($this->session->data['compare']) : 0));
// 			$data['text_sort'] = $this->language->get('text_sort');
// 			$data['text_limit'] = $this->language->get('text_limit');
...
//             //该分类的描述
// 			//$data['description'] = html_entity_decode($hotproduct_info['description'], ENT_QUOTES, 'UTF-8');
// 			//产品的对比
// 			//$data['compare'] = $this->url->link('product/compare');
...
// 			$pagination->page = $page;
// 			$pagination->limit = $limit;
// 			$pagination->url = $this->url->link('product/hotproduct', 'path='  . $url . '&page={page}');
